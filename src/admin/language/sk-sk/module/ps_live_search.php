...
$_['text_getting_started']                 = '<p><strong>Prehľad:</strong> Playful Sparkle - Live Search je pokročilé vyhľadávacie rozšírenie pre OpenCart 4, navrhnuté tak, aby zobrazovalo výsledky vyhľadávania dynamicky v rozbaľovacom zozname, keď používateľ píše. Podporuje vyhľadávanie produktov, kategórií, výrobcov a informačných stránok, s prispôsobiteľnými veľkosťami miniatur, dĺžkami popisov a nastaveniami oneskorenia pre optimálny používateľský zážitok.</p><p><strong>Požiadavky:</strong> OpenCart 4.x+, PHP 7.4+ alebo vyššie</p>';
$_['text_setup']                           = '<ul><li><strong>Všeobecné nastavenia:</strong> Nakonfigurujte oneskorenie vstupu (predvolené: 100 ms) na kontrolu času medzi stlačeniami klávesov a zobrazením výsledkov vyhľadávania.</li><li><strong>Nastavenia produktu:</strong><ul><li>Povoliť/zakázať výsledky vyhľadávania produktov.</li><li>Povoliť/zakázať zobrazenie popisov produktov; nastaviť maximálnu dĺžku popisu (predvolené: 100 znakov).</li><li>Povoliť/zakázať miniatury produktov; nastaviť šírku a výšku miniatur (min: 16 px, max: 128 px).</li></ul></li><li><strong>Nastavenia kategórie:</strong><ul><li>Povoliť/zakázať výsledky vyhľadávania kategórií.</li><li>Povoliť/zakázať miniatury kategórií; nastaviť rozmer miniatur (min: 16 px, max: 128 px).</li></ul></li><li><strong>Nastavenia výrobcu:</strong><ul><li>Povoliť/zakázať výsledky vyhľadávania výrobcov.</li><li>Povoliť/zakázať miniatury výrobcov; nastaviť rozmer miniatur (min: 16 px, max: 128 px).</li></ul></li><li><strong>Nastavenia informačnej stránky:</strong><ul><li>Povoliť/zakázať výsledky vyhľadávania informačných stránok.</li></ul></li></ul>';
$_['text_troubleshot']                     = '<ul><li><strong>Živé vyhľadávanie nefunguje:</strong> Kliknite na tlačidlo "Opraviť spracovateľ udalostí", overte nastavenie oneskorenia vstupu a uistite sa, že je modul povolený.</li><li><strong>Chýbajú konkrétne výsledky (Produkt, Kategória, Výrobca, Informácie):</strong> Potvrďte, že relevantná kategória výsledkov je povolená v nastaveniach.</li></ul>';
