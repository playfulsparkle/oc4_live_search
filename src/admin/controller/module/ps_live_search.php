...
class PsLiveSearch extends \Opencart\System\Engine\Controller
{
     ...
     */
    const GITHUB_REPO_URL = 'https://github.com/playfulsparkle/oc4_live_search';
    ...
    public function index(): void
    {
        ...
        $data['module_ps_live_search_product_description'] = (bool) $this->config->get('module_ps_live_search_product_description');
        ...
        $data['module_ps_live_search_category_image_width'] = (int) $this->config->get('module_ps_live_search_category_image_width');
        $data['module_ps_live_search_category_image_height'] = (int) $this->config->get('module_ps_live_search_category_image_height');

        $data['module_ps_live_search_manufacturer_status'] = (bool) $this->config->get('module_ps_live_search_manufacturer_status');
        $data['module_ps_live_search_manufacturer_image'] = (bool) $this->config->get('module_ps_live_search_manufacturer_image');
        $data['module_ps_live_search_manufacturer_image_width'] = (int) $this->config->get('module_ps_live_search_manufacturer_image_width');
        $data['module_ps_live_search_manufacturer_image_height'] = (int) $this->config->get('module_ps_live_search_manufacturer_image_height');
    ...
    public function save(): void
    {
        ...
        if (!$json) {
            ...
            if ((int) $this->request->post['module_ps_live_search_category_image_width'] < 16) {
                $json['error']['input-category-image-width'] = $this->language->get('error_category_image_width_min');
            } else if ((int) $this->request->post['module_ps_live_search_category_image_width'] > 128) {
                $json['error']['input-category-image-width'] = $this->language->get('error_category_image_width_max');
            }

            if ((int) $this->request->post['module_ps_live_search_category_image_height'] < 16) {
                $json['error']['input-category-image-height'] = $this->language->get('error_category_image_height_min');
            } else if ((int) $this->request->post['module_ps_live_search_category_image_height'] > 128) {
                $json['error']['input-category-image-height'] = $this->language->get('error_category_image_height_max');
            }

            if ((int) $this->request->post['module_ps_live_search_manufacturer_image_width'] < 16) {
                $json['error']['input-manufacturer-image-width'] = $this->language->get('error_manufacturer_image_width_min');
            } else if ((int) $this->request->post['module_ps_live_search_manufacturer_image_width'] > 128) {
                $json['error']['input-manufacturer-image-width'] = $this->language->get('error_manufacturer_image_width_max');
            }

            if ((int) $this->request->post['module_ps_live_search_manufacturer_image_height'] < 16) {
                $json['error']['input-manufacturer-image-height'] = $this->language->get('error_manufacturer_image_height_min');
            } else if ((int) $this->request->post['module_ps_live_search_manufacturer_image_height'] > 128) {
                $json['error']['input-manufacturer-image-height'] = $this->language->get('error_manufacturer_image_height_max');
            }
    ...
    public function install(): void
    {
        ...
        $data = [
            ...
            'module_ps_live_search_category_image' => 0,
            ...
            'module_ps_live_search_manufacturer_image' => 0,
            ...
            'module_ps_live_search_status' => 0,
        ];
